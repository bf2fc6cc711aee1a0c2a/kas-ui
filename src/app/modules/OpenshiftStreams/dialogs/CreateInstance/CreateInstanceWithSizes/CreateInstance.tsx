...
import { BaseModalProps, CreateInstanceProps } from '@rhoas/app-services-ui-shared';
import { QuickStartContext } from '@patternfly/quickstarts';
import { FunctionComponent, useCallback, useContext } from 'react';
import { useGetAvailableSizes, useCreateInstance, useAvailableProvidersAndDefault } from './hooks/';

const CreateInstanceWithSizes: FunctionComponent<CreateInstanceProps & BaseModalProps> = ({ hideModal, onCreate }) => {
  ...
  const onClickQuickStart = useCallback(() => {
    qsContext.setActiveQuickStart && qsContext.setActiveQuickStart('getting-started');
  }, [qsContext]);

  const handleCreate = useCallback<CreateKafkaInstanceWithSizesTypes.OnCreateKafka>(
